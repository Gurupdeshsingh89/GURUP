    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">GURUPDESH shop - Administrator Panel</a>
            </div>
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-danger">
                        ...
                        &nbsp; &nbsp; Welcome to GURUPDESH shop! So, if you're looking for an Element skateboard, why not visit the GURUPDESH shop? 
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2016 GURUPDESH shop| All Rights Reserved |  Design by : GURUPDESH
