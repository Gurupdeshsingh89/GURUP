...
<body >
 ...
 <div class="container">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE GURUPDESH shop <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2016 GURUPDESH shop| All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : GURUPDESH</a>
    </div>
     <!-- FOOTER SECTION END-->
